...
namespace lab2.Application.Queries.BankAccount
{
    public class GetAcccountInformation
    {
        ...
        public class Handler : IRequestHandler<Query,AccountProductsViewModel>
        {
            ...
            public Handler(IMapper mapper,IUserRepository userRepository, IBankAccountRepository bankAccountRepository, ISavingAccountRepository savingAccountRepository, ICheckingAccountRepository checkingAccount, ITimeDepositRepository timeDepositRepository)
            {
